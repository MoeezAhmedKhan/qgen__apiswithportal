                            ...
                            <table id="example" class="table table-hover">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`, `fullname`, `phone`, `email`, `address`, `password`,`status`,
                                         `created_at` FROM `users` WHERE role_id != 0";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>{$sn}</td>";
                                            echo "<td>{$row['id']}</td>";
                                            echo "<td name='name'>{$row['fullname']}</td>";
                                            echo "<td name='phone'>{$row['phone']}</td>";
                                            echo "<td name='email'>{$row['email']}</td>";
                                            echo "<td name='address'>{$row['address']}</td>";
                                            echo "<td name='pass'>{$row['password']}</td>";
                                            echo "<td name='status'>{$row['status']}</td>";
                                            echo "<td name='dat'>{$row['created_at']}</td>";
                                            
                                            
                                            echo "<td><button class='btn btn-primary'  onclick='openAddMore({$row['id']},{$index})' >Update</button></td>";
                                            
                                            // echo '<td><a href="user_status_edit.php?Id='.$row['id'].'"><i class="fa fa-edit"></i></a></td>';
