...
<?php
  ...
  if(isset($_GET['Massage'])){
      if($_GET['Massage'] == 'Sucessfully updated announcements.'){
         echo "<script>alert('Sucessfully updated announcements.')</script>";
       }else{
          echo "<script>alert('Sucessfully updated announcements.')</script>";
       }
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT `id`, `title`, `description` FROM `sliders` ORDER BY id DESC ";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>{$sn}</td>";
                                            echo "<td>{$row['id']}</td>";
                                            echo "<td name='name'>{$row['title']}</td>";
                                            echo "<td name='email'>{$row['description']}</td>";
                                         
                                            echo "<td><button class='btn btn-primary' onclick='openAddMore({$row['id']},{$index})' >Update</button>
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Edit Announcement</h2>
         ...
         <input hidden type="text" name="id" id="id">  
             <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control"  value="" type="text" name="title" id="Title" placeholder="Enter Name" > 
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="text" name="descr" id="Descr" placeholder="Enter Email" > 
                    </div>
                  </div>
       ...
       <button type="submit" name="btnUpdateAnnouncement" class="btn btn-primary">Submit</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,index){
     ...
     document.getElementById('Title').value = document.getElementsByName('name')[index].innerText;
     document.getElementById('Descr').value = document.getElementsByName('email')[index].innerText;
...
function deleteRow(id){
    var req = new XMLHttpRequest();
      req.open("get","assets/Actions.php?FunctionName=DeleteAnnouncement&id="+id,true);
      req.send();
