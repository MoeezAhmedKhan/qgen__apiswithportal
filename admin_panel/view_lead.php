        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">View Leads</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">View Leads
                    </li>
                  </ol>
                </div>
              </div>
                            ...
                            <table id="example" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>First Name</th>
                                        <th>Last Name</th>
                                        <th>Address of Prop</th>
                                        <th>City of Proper</th>
                                        <th>State of Proper</th>
                                        <th>Zip Code</th>
                                        <th>Sin Number</th>
                                        <th>Email of Client</th>
                                        <th>Number of Client</th>
                                        <th>Alternative of Client</th>
                                        <th>Client Issue</th>
                                        <th>Image One</th>
                                        <th>Image Two</th>
                                        <th>Video One</th>
                                ...
                                <tbody>
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            <td>
                                                <?php
                                                $r13 = json_decode($row['13']);
                                                $r15 = json_decode($row['15']);
                                                ?>

                                                <a href = "https://sassolution.org/waterproofing/API/Uploads/<?php echo $r13[0] ?>"/>
                                                <img src = "https://sassolution.org/waterproofing/API/Uploads/<?php echo $r13[0] ?>" height="50" width="50" id="img1"/>
                                            </td>
                                            <td>
                                               <a href = "https://sassolution.org/waterproofing/API/Uploads/<?php echo $r13['1'] ?>"/>
                                                <img src = "https://sassolution.org/waterproofing/API/Uploads/<?php echo $r13['1'] ?>"  height="50"  width="50" id="img2"/>
                                            </td>
                                             <!--end img-->
                                            ...
                                            <td>
                                                ...
                                                <a href="https://sassolution.org/waterproofing/API/videos/<?php echo $video1[0].".mp4" ?>"><i class="fa fa-cloud-download" style="font-size:35px"></i></a>
                                            </td>
                                            
                                            <td>
                                                <a href="https://sassolution.org/waterproofing/API/videos/<?php echo $video2[0].".mp4" ?>"><i class="fa fa-cloud-download" style="font-size:35px"></i></a>
                                            </td>
                                            ...
                                            echo'
                                            <td><a href="edit_lead.php?Id='.$row[0].'"><i class="fa fa-edit" style="font-size:16px"></i></a></td>
                                            <td><a href="delete_lead.php?Id='.$row[0].'"><i class="fa fa-trash" style="font-size:16px"></i></a></td>';
                                          echo "</tr>";
                                          $index++;
                                      }
                                      
                                      ?>
<!--onclick='openAddMore({$row['id']},{$index})'    -->
