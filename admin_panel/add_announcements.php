...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new announcement.'){
       echo "<script>alert('Sucessfully added new announcement.')</script>";
       header("Refresh: 1; url='add_announcements.php'");
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Announcement</h2>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="desc" class="form-control" placeholder="Add Description" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_insertAnnouncement"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
