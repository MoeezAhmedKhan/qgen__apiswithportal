        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Edit User Status</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit User Status
                    </li>
                  </ol>
                </div>
              </div>
			...
			<div class="card">
				...
				<div class="card-content">
					...
					<form class="form-horizontal" method="POST">
                                   ...
                                   <div class="controls">
                                       <label>Status</label>
                                        <select name="u_status" class="form-control">
                                            ...
                                            <option value="deactivate" <?php if($arr['Status'] == "deactivate"){echo "selected";} ?>>deactivate</option>
                                        </select>
                                    </div>
    							</div>
    						</div>
                      ...
                      <div class="col-sm-12">
                          <button type="Submit" name="btn_status"  class="btn btn-primary">Submit</button>
                     </div>
					...
					<?php
                        ...
                        //   die();
                          ...
                          require_once('connection.php');
                                ...
                                $update = "UPDATE `users` SET `Status`= '$user_status' WHERE id = '$id'";
                                
                                $run = mysqli_query($conn ,$update);
                                if($run)
                                {
                                   ?>
                                   <script>alert("Your update has been done.");window.location.href = "view_user.php";</script>
                                   <?php
                                }
                                else
                                {
