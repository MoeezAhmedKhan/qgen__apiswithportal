        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage List</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Manage List
                    </li>
                  </ol>
                </div>
              </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage List</h4>
                </div>
                <div class="card-body">
                            ...
                            <table id="example" class="table table-hover">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $client = "SELECT l.id,c.full_name,u.fullname,cat.title FROM list l INNER JOIN clients c on c.id = l.user_id INNER JOIN users u on u.id = l.vendor_id INNER JOIN categories cat on cat.id = l.category_id";
                                        $result = mysqli_query($conn,$client);
                                        $index = 0;
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>{$sn}</td>";
                                            echo "<td>{$row['id']}</td>";
                                            echo "<td name='name'>{$row['full_name']}</td>";
                                            echo "<td name='email'>{$row['fullname']}</td>";
                                            echo "<td name='email'>{$row['title']}</td>";
                                        ...
                                        //     echo "<td><button class='btn btn-primary' style='width:140%' onclick='deleteRow({$row['id']})' >View Revenue</button></td>";
                                          echo "</tr>";
                                          $index++;
                                      }
