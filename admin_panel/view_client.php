...
<?php
  ...
  if(isset($_GET['Massage'])){
      if($_GET['Massage'] == 'Sucessfully updated client'){
         echo "<script>alert('Sucessfully updated client')</script>";
       }else{
          echo "<script>alert('Sucessfully updated client')</script>";
       }
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Manage Clients</h2>
                            ...
                            <table id="example" class="table table-hover">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $client = "SELECT c.id,c.full_name,c.email,c.contact,c.address,c.status,c.created_at,u.fullname from clients c INNER JOIN users u on c.added_by = u.id";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            ...
                                            echo "<td name='phone'>{$row['contact']}</td>";
                                            echo "<td name='address'>{$row['address']}</td>";
                                            echo "<td name='fname'>{$row['fullname']}</td>";
                                            echo "<td name='status'>{$row['status']}</td>";
                                            echo "<td name='dat'>{$row['created_at']}</td>";
...
<div id="myModal" class="modal">
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
       ...
       <button type="submit" name="BtnUopdateclientStatus" class="btn btn-primary">Submit</button>
       </form>
      </div>
