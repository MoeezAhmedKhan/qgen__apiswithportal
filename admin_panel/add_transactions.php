...
if(isset($_GET['Massage'])){
    if($_GET['Massage'] == 'Sucessfully added new transaction.'){
       echo "<script>alert('Sucessfully added new transaction.')</script>";
       header("Refresh: 1; url='add_transactions.php'");
              ...
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add New Transaction
                    </li>
                  </ol>
                </div>
              </div>
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="number" name="amount" class="form-control" placeholder="Add amount to transaction" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
                        ...
                        $sql = "SELECT `id`,`first_name`  FROM `users` WHERE `role_id` = 1";
                      ...
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_insertrevenue"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
