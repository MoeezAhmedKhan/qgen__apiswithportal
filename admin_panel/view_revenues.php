        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Transactions History</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Transactions History
                    </li>
                  </ol>
                </div>
              </div>
                            ...
                            <table id="example" class="table">
                                ...
                                <tbody>
                                      ...
                                      include_once('connection.php');
                                         $users="SELECT u.id , u.first_name, u.last_name, r.total_revenue, r.revenue_last_given FROM `revenue` AS r INNER JOIN `users` u ON u.id = r.user_id ORDER BY u.id DESC";
                                      ...
                                      while($row = mysqli_fetch_array($result)){
                                          ...
                                          echo "<tr>";
                                            echo "<td>{$sn}</td>";
                                            echo "<td>{$row['id']}</td>";
                                            echo "<td name='nam'>{$row['first_name']} {$row['last_name']}</td>";
                                            
                                            echo "<td name='rev' >{$row['total_revenue']}</td>";
                                            echo "<td name='rev_date'>{$row['revenue_last_given']}</td>";
    ...
    <div id="myModal_Add" class="modal">
      ...
      <div class="modal-content-Updated">
        ...
        <h2>Edit Revenue</h2>
         ...
         <form method="POST" action="assets/Actions.php">
         <input hidden  type="text" name="id" id="id">  
             <div class="col-sm-12">
              
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" disabled  value="" type="text" name="name" id="Name" placeholder="User Id" > 
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="text" name="email" id="Email" placeholder="Revenue" > 
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <div class="controls">
                        <input class="form-control" value="" type="date" name="time" id="time"> 
                    </div>
                  </div>
       ...
       <button type="submit" name="btnUpdaterevenue" class="btn btn-primary">Submit</button>
       </form>
      </div>
...
var modal_Add = document.getElementById("myModal_Add");
 ...
 function openAddMore(id,index){
     ...
     document.getElementById('Name').value = document.getElementsByName('nam')[index].innerText;
     document.getElementById('Email').value = document.getElementsByName('rev')[index].innerText;
     document.getElementById('time').value = document.getElementsByName('rev_date')[index].innerText;
