        ...
        <div class="content-header row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Add Questions</h2>
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Add New Questions
                    </li>
                  </ol>
                </div>
              </div>
	...
	<div class="row">
					...
					<form class="form-horizontal" action="phpfiles/insertions.php" method="POST" enctype="multipart/form-data">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="CatName" class="form-control" placeholder="Question Name" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
    			    	<div class="col-sm-6">
							<div class="form-group">
								<div class="controls">
                                   <div class="controls">
                                   <input type="text" name="CatDes" class="form-control" placeholder="Question Description" required="">
                                    </div>
    							</div>
    						</div>
    			    	</div>
       ...
       <!--                             </div>-->
    			...
    			<!--    	</div>-->
    			        ...
    			        <div class="col-sm-6">
							<button type="button" name="add" id="add"    class="btn btn-primary mb-5">Add More</button>
    			    	</div>
                      <div class="col-sm-12">
							...
							<button type="Submit" name="btnSubmit_insertquestion"  class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
...
$(document).ready(function() {
  ...
  $('#add').click(function() {
    if (i <= 20) {
      $('#dynamic_fields').append('<div class="row"><div class="col-sm-12" ><div class="form-group"><input type="text" name="answers[]" class="form-control" placeholder="Answers" required=""></div></div></div>')
      i++;
    }
  });
